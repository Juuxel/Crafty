...
open class CraftyBlock(val settings: CraftyBlockSettings) : Block(settings.toMc()) {
...
class CraftyWaterloggableBlock(settings: CraftyBlockSettings) : CraftyBlock(settings), Waterloggable {
    init {
